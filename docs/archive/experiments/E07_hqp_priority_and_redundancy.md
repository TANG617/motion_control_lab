...
状态：`implemented-development`；正式运行和分析 deferred。公共定义：[PROTOCOL](../../mcc_placo_study/PROTOCOL.md)、[DATA_ANALYSIS](../../mcc_placo_study/DATA_ANALYSIS.md)。输入：[inputs](../../../experiments/E07_hqp_priority_and_redundancy/inputs/README.md)。消费：[A01](../../../analyses/A01_priority_and_robustness/README.md)。对应 G01/G03–G06；C1；F02/F03、T01。
...
python3 tools/mcc_placo_study/study.py --experiment E07 --case CASE --method METHOD --repeat 0 --phase development --smoke --timeout 60
```
