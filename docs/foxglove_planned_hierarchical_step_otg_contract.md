# Planned Hierarchical Step OTG Foxglove 合同

版本：`mcl.foxglove_planned_hierarchical_step_otg.v1`

机器可读合同见
[`contracts/visualization/foxglove_planned_hierarchical_step_otg.v1.json`](../contracts/visualization/foxglove_planned_hierarchical_step_otg.v1.json)。
