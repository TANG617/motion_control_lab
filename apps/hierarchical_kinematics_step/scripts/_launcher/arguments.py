...
VALUE_FLAGS = (
    ...
    "maximum-torque", "wrench-filter-alpha", "red-qp-regularization",
    ...
    "max-angular-jerk-rps3", "cartesian-maximum-sample-count",
    "cartesian-synchronization", "joint-synchronization", "joint-algorithm",
    "joint-maximum-sample-count", "joint-target-mode",
