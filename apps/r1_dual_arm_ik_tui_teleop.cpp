...
int main(int argc, char ** argv)
{
  try {
    ...
    auto initial_targets = solver_session.currentTargetPoses({
    ...
    visualization_sink->open({"interactive-preview", "r1_dual_arm_ik_tui_teleop"});
    ...
    std::cerr << "r1_dual_arm_ik_tui_teleop: " << error.what() << "\n";
    return EXIT_FAILURE;
  }
}
