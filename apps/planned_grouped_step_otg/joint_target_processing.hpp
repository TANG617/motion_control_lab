...
inline constexpr std::array<double, kR1JointCount> kR1StreamMaxAccelerationRadPerS2{
...
public:
  JointTargetBuilder(JointTargetMode mode, double sample_period,
                     std::size_t joint_count,
                     double velocity_deadband =
                         kFutureO1VelocityDeadbandRadPerS);
