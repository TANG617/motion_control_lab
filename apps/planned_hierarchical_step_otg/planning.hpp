...
inline constexpr double kReplaySettlingFkPositionM = 1.0e-4;
inline constexpr double kReplaySettlingFkOrientationRad = 1.0e-4;
inline constexpr double kReplaySettlingVelocityRadPerS = 5.0e-3;
inline constexpr double kReplaySettlingAccelerationRadPerS2 = 1.0;
inline constexpr std::size_t kReplayRequiredSettledCycles = 50U;
...
public:
  explicit ReplaySettlingCounter(
      std::size_t required_cycles = kReplayRequiredSettledCycles)
