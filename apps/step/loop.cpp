...
using mcl::step::AppOptions;
using mcl::step::MccBackend;
using mcl::step::MccServoSolver;
using mcl::step::PlacoServoSolver;
using mcl::step::ReplayAppOptions;

constexpr const char *kProgramId = "mcl_step";
constexpr const char *kTitle = "Dual-arm IK — Step";
...
int runReplayWithSolver(ReplayAppOptions options, const std::string &solver_id,
  ...
  execution.topology = "ordinary-step";
