...
本实验通过 step、hierarchical_kinematics_step、optimization_problem 的公开入口执行。具体单位、配置、repeat、输入与能力缺项
...
```bash
python3 experiments/E07_hqp_priority_and_redundancy/prepare.py --output /absolute/new-E07.json
python3 tools/app_execution/run.py --definition /absolute/new-E07.json \
...
历史设计、完整指标说明与当时验收见 [原实验记录](../../docs/archive/experiments/E07_hqp_priority_and_redundancy.md)；
