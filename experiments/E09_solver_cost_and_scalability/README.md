...
本实验通过 step、target、hierarchical_kinematics_step 的公开入口执行。具体单位、配置、repeat、输入与能力缺项
...
```bash
python3 experiments/E09_solver_cost_and_scalability/prepare.py --output /absolute/new-E09.json
python3 tools/app_execution/run.py --definition /absolute/new-E09.json \
...
历史设计、完整指标说明与当时验收见 [原实验记录](../../docs/archive/experiments/E09_solver_cost_and_scalability.md)；
