...
```bash
python3 experiments/E12_recorded_motion_holdout/prepare.py --output /absolute/new-E12.json
python3 tools/app_execution/run.py --definition /absolute/new-E12.json \
...
历史设计、完整指标说明与当时验收见 [原实验记录](../../docs/archive/experiments/E12_recorded_motion_holdout.md)；
