...
权威公共定义：[PROTOCOL](../../docs/mcc_placo_study/PROTOCOL.md)、[DATA_ANALYSIS](../../docs/mcc_placo_study/DATA_ANALYSIS.md)。输入：[inputs](inputs/README.md)。输出由 [A01](../../analyses/A01_priority_and_robustness/README.md) 消费。对应 G02/G03/G04/G06；为 C1–C6 提供比较准入；F02、T01。
...
python3 tools/mcc_placo_study/study.py --experiment E06 --case CASE --method METHOD --repeat 0 --phase development --smoke --timeout 60 --output-root /workspace/runs/mcc-placo-development
```
