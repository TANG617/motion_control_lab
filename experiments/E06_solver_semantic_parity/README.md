# E06：方程、求解模式与原生接受策略是否可比

> 更新日期：2026-09-14

本实验通过 step、target、optimization_problem 的公开入口执行。具体单位、配置、repeat、输入与能力缺项
...
历史设计、完整指标说明与当时验收见 [原实验记录](../../docs/archive/experiments/E06_solver_semantic_parity.md)；
