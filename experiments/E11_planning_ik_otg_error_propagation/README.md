# E11：Cartesian planning、IK 与 OTG 误差传播

> 更新日期：2026-09-14

本实验通过 planned_kinematics_step、hierarchical_kinematics_step 的公开入口执行。具体单位、配置、repeat、输入与能力缺项
...
```bash
python3 experiments/E11_planning_ik_otg_error_propagation/prepare.py --output /absolute/new-E11.json
python3 tools/app_execution/run.py --definition /absolute/new-E11.json \
...
历史设计、完整指标说明与当时验收见 [原实验记录](../../docs/archive/experiments/E11_planning_ik_otg_error_propagation.md)；
