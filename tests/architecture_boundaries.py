...
MCC_COMPONENT_PATTERNS = (
    ...
    re.compile(r"\bmotion_control::core::(?:KinematicsSolverBuilder|HierarchicalKinematicsSolver|CartesianTrajectoryGenerator|JointPtpTrajectoryGenerator)\b"),
...
APP_MAIN_REQUIREMENTS = {
    ...
    "hierarchical_kinematics_step": ("parseOptions", "SolverRuntime", "configureSolver", "CartesianTrajectoryGenerator", "JointPtpTrajectoryGenerator", "runLoop"),
